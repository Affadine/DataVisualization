...
<div>
    ...
    <div class="row">
        ...
        <div class="col-8">
            <p class="text-muted">
                In this visualization we show the geographic distribution of different species and sub species of bees. You can filter then by year using the slider and the species listed on the right by selection then.
            </p>
        </div>
    </div>
    <div class="card">
